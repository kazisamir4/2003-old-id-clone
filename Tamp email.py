#kazisamir4 
 ...
      time.sleep(0.01) 
 def maogit(): 
   os.system("xdg-open https://github.com/kazisamir4/") 
 def ext(): 
 ...
   {acl}[{gcl} 6{bcl}.{acl} ]{ycl} GITHUB {acl}[{bcl} kazisamir4 {acl}] 
 ...
   {acl}[{gcl} 7{bcl}.{acl} ]{ycl} GITHUB {acl}[{bcl} kazisamir4 {acl}] 
   {acl}[{rcl} 0{bcl}.{acl} ]{rcl} EXIT {acl}[{bcl} ×××{acl} ] 
   """.format(acl=acl,bcl=bcl,gcl=gcl,ycl=ycl,rcl=rcl,ccl=ccl) 
   try: 
      
 ...
     {acl}[{gcl} 5{bcl}.{acl} ]{ycl} GITHUB {acl}[{bcl} kazisamir4 {acl}] 
 ...
     {acl}[{gcl} 4{bcl}.{acl} ]{ycl} GITHUB {acl}[{bcl} kazisamir4 {acl}] 
     {acl}[{rcl} 0{bcl}.{acl} ]{rcl} EXIT{acl} [{rcl} ××× {acl}] 
     """.format(acl=acl,bcl=bcl,gcl=gcl,ycl=ycl,rcl=rcl,ccl=ccl) 
     while True: 
