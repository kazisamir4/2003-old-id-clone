...
##    ## ##     ## ##     ##  ##  ##    ##  
 ######  ##     ## ##     ## #### ##     ## 
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : FOURKANUDDIN123
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : UNKNOWN  
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : kazisamir4
...
\033[1;90m══════════════════════════════════════════════════
    """)
		...
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2003-11 {JUST NOW} %s(FREE)"%(G,R,G,Y,B))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [samir] : %s/%s -> \033[0;92m [ BY-OK:%s ]- \033[0;91m[BY-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://facebook.com/FOURKANUDDIN123 ")
		print(" [*] Instagram : https://instagram.com/fourkanuddintanvir")
		print(" [*] YouTube   : https://youtube.com/kazi samir")
		exit(" [*] GitHub    : https://github.com/kazisamir4")
	else:
		Main()
